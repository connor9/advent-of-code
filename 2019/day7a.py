...
# amplifier's output leads to the third amplifier's input, and so on. The first amplifier's input value is 0,
...
if __name__ == '__main__':
    ...
    #         inputs = [seed, output]
    #
    #         intcode = IntcodeComputer(inputs)
    ...
    for perm in perms:
        ...
        for seed in perm:
            ...
            intcode.inputs.put(seed)
            intcode.inputs.put(output)
